class Api::V1::OrderItemsController < Api::V1::BaseController
    ...
    def create
        ...
        if params[:order_id].present?
            order = OrderItem.update_order(params[:order_id],params[:item_id], params[:quantity], params[:restaurant_id], params[:user_id], params[:order_restaurant_id])
            ...
            if order
                ...
                render(json: Api::V1::OrderSerializer.new(order).to_json)
            else
